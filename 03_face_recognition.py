...
def start():
    ...
    while ret:
        ...
        print("\n\n\n\n")
        print("----------------------------------------------")
        labels = ['Bharath', 'Naidile', 'Bharath', 'Deepashree', 'Vamshi', 'vamshi d', 'Bharath', 'Pruthvi', 'Meghana']
        ...
        for (x, y, w, h) in faces:
            if prediction[0][n] > 0.5:
                ...
                try:
                    cv2.rectangle(nframe, (x, y), (x+w, y+h), (0, 255, 0), 2)
                    cv2.putText(nframe, "Loading", (x+5, y-5), font, 1, (255, 255, 255), 2)
                    # cv2.putText(nframe, str(confidence), (x+5,y+h-5), font, 1, (255,255,0), 1)
                except:
                    la = 2
